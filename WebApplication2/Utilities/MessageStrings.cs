namespace WebApplication2.Utilities
{
    public static class MessageStrings
    {
        ...
        public static readonly string ProductAddedSuccess = "Product Added Successfully";
        public static readonly string ProductAddedFail = "Product not Added";
        ...
        public static readonly string CategoryAddedSuccess = "Category Added Successfully";
        public static readonly string CategoryAddedFail = "Category not Added";
        public static readonly string ForgotPasswordLink = "Forgot Password Link sent to your Email";
        public static readonly string ErrorForgotPasswordLink = "Error in Forgot Password Link";
        public static readonly string PasswordChangesSuccessfuly = "Password Changed Successfully";
        public static readonly string SoftDeletedSuccess = "Soft Deleted Successfully";
        public static readonly string FileNotExist = "File Not Exist";
        public static readonly string noimageAttach = "No Image attach";
